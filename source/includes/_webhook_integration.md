...
| leads[].program.programVariables               | true     | object | An object containing values specific to your application. If you have values that you need our API to return for this field, please contact your Evocalize account representative. |
